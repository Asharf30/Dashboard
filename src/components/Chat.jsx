...
const Chat = () => {
  ...
  return (
    <div className="nav-item absolute right-2 md:right-52 top-16 bg-white dark:bg-[#42464D] p-6 md:p-8 rounded-lg w-full max-w-sm md:max-w-none md:w-96 shadow-xl">
